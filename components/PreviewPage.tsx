...
import type { AvatarStyle, BlockData, SavedBento, UserProfile } from '../types';
...
const getPageLayout = (profile: UserProfile) => profile.pageLayout || 'bento';
...
const PreviewPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setExpandedCollections((prev) => {
      ...
      bento.data.blocks.forEach((block) => {
  ...
  // Sort blocks for mobile and vertical layouts
        ...
        {selectedPageLayout === 'vertical-links' ? (
          <div className="mx-auto w-full max-w-2xl px-4 pt-8 pb-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 leading-none mb-2">
                {profile.name}
              </h1>
              <p className="text-sm text-gray-500 font-medium whitespace-pre-wrap max-w-md leading-relaxed">
                {profile.bio || '—'}
              </p>
              {renderSocialIcons()}
            </div>
                ...
                if (isCollectionBlock(block)) {
                  ...
                  return (
                    <div
                      ...
                      style={
                        block.customBackground ? { background: block.customBackground } : undefined
                      }
                    >
                      <button
                        type="button"
